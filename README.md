...
### Process-Level Latency Dashboard

You can launch an interactive dashboard that:
...
```bash
streamlit run ebpf_logs/process_latency_dashboard.py
```

By default, it reads `ebpf_logs/ebpf_events.csv`, which is generated by `collector`.
